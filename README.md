...
The `lerobot` environment and scripts support W&B natively. If you want to use W&B to visualize the training process (training dynamics, system resource usage), you can first log in from the terminal:
