...
| SmolVLA | [Paper](https://arxiv.org/pdf/2506.01844) | 450M                     | `pip install num2words`               | `--policy.type=smolvla --policy.train_expert_only=true` | 4 GB per GPU |                        3.75 h                        |  Can complete the task, but the motions are not smooth     |
